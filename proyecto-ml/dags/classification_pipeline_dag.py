"""DAG para ejecutar el pipeline `modelo_clasificacion` de Kedro
...
with DAG(
    ...
    description='Entrena modelos de clasificación',
    ...
    'elif [ -f "/home/airflow/proyecto-ml/pyproject.toml" ]; then cd /home/airflow/proyecto-ml; '
        ...
        'kedro run --pipeline=modelo_clasificacion --env local'
    )
